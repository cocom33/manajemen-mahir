        ...
        <div class="mt-5">
            <div>
                ...
                @else
                    ...
                    @if ($project->keuangan_project->type == 'langsung')
                        {{-- <div>
                             Ini Sampah Kalo Mau DIpake Lagi Hapus Dulu Div Pembungkus nya
                                    ...
                                    <tbody>
                                        @foreach ($fee_langsung as $item)
                                            <tr>
                                                ...
                                                <td class="text-center border-b">{{ $item->created_at->format('d M Y') }}
                                                </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center border-b">{{ $project->created_at->format('d M Y') }}
                                            </td>
                                            <td class="border-b w-5">
