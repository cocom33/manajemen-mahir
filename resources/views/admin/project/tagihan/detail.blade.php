        ...
        <div class="mt-5">
            ...
            <div class="mt-3">
                ...
                <div class="flex w-full gap-3">
                    <x-form-input label="Harga Awal" name="" addon="w-full" value="Rp. {{ number_format($tagihan->harga_awal) }}" readonly="readonly" required="false" />
                    <x-form-input label="Harga Asli" name="" addon="w-full" value="Rp. {{ number_format($tagihan->harga_asli) }}" readonly="readonly" required="false" />
