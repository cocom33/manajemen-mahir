                        ...
                        <tr>
                            ...
                            <td class="text-center border-b">
                                ...
                                <form action="{{ route('project.edit.team', $project->slug) }}" method="post" id="formEdit{{ $key }}">
                                    ...
                                    <input type="number" name="fee" id="input-fee{{ $key }}" class="hidden input w-full border" value="{{ $team->fee ?? 0 }}">
                                </form>
                            </td>
    ...
    <script>
        @foreach($projectTeams as $key => $team)
            function editTeam{{ $key }}() {
                ...
                document.getElementById('input-fee{{ $key }}').classList.toggle('hidden')
