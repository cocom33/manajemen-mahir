            ...
            <div class="p-5" id="vertical-form">
                <div class="preview">
                    <div>
                        ...
                        <input type="text" required name="name" class="input w-full border mt-2" placeholder="Nama Client">
                    </div>
                    <div class="mt-3">
                        <label>Sumber</label>
                        <select name="sumber" required class="input w-full border mt-2">
                    ...
                    <div class="mt-3">
                        ...
                        <input type="number" name="wa" required class="input w-full border mt-2" placeholder="+62 895-1459-6251">
                    </div>
                    <div class="mt-3">
                        <label>Email</label>
